 ...
 * states.inc.php
 *
 * CairoCorridor game states description
 *
 */
...
$machinestates = array(
    ...
    2 => array(
    		...
    		"descriptionmyturn" => clienttranslate('${you} must claim a pentagon'),
    		"type" => "activeplayer",
    		"possibleactions" => array( "claimSpace" ),
    		"transitions" => array( "claimSpace" => 3, "zombiePass" => 99)
    ),
